...
async function notifyArticle(bot, doc) {
    const t = doc.data();
...
export function startNewsApprovalScheduler(bot) {
    setInterval(async () => {
        try {
...
export async function handleNewsCallback(bot, action, articleId, chatId, messageId) {
