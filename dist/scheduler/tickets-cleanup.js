...
const SCHEDULE = '30 3 * * *';
async function purgeTicket(docId, attachments) {
...
export function startTicketCleanupScheduler() {
    cron.schedule(SCHEDULE, () => {
        runOnce().catch((err) => console.error('[tickets-cleanup] scheduler error:', err));
